namespace FFmpeg.AutoGen
{
    ...
    internal sealed unsafe class FFAudioParams
    {
        ...
        static FFAudioParams()
        {
            ...
            AVChannelLayout* defaultLayoutPtr = &defaultLayout;
            ffmpeg.av_channel_layout_default(defaultLayoutPtr, Output.ChannelCount);

            Output.ChannelLayout = defaultLayout;
        ...
        internal static FFAudioParams CreateSource(AVFrame* frame)
        {
            ...
            if (spec.ChannelLayout.u.mask == 0)
            {
                AVChannelLayout defaultLayout;
                AVChannelLayout* defaultLayoutPtr = &defaultLayout;
                ffmpeg.av_channel_layout_default(defaultLayoutPtr, spec.ChannelCount);

                spec.ChannelLayout = defaultLayout;
            }
